...
public class GrenadeV4Projectile extends ThrowableItemProjectile {
    public GrenadeV4Projectile(EntityType<? extends ThrowableItemProjectile> entityType, Level level) {
    ...
    public GrenadeV4Projectile(Level level) {
        super(ModEntities.KOFFA_PROJECTILE.get(), level);
    }

    public GrenadeV4Projectile(Level level, LivingEntity livingEntity) {
